...
<template>
  <div class="business-container">
    ...
    <Input placeholder="车牌号、卡号" v-model="truckNo" clearable style="width: 200px;margin-top:5px;" />
    <Button v-auth="'coalTransfer.xmMeasureModify.query'" type="primary" icon="ios-search" @click="onSearch()" :loading="loading" style="margin-top:5px;" >查询</Button>
    <Button v-auth="'coalTransfer.xmMeasureModify.add'" type="warning" icon="plus-round" @click="modify()" style="margin-top:5px;" >卸煤计量数据修改</Button>
    <br><br>
