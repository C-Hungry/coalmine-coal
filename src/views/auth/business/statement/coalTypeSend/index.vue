...
<template>
  <div class="business-container">
    ...
    <Button v-auth="'statement.coalTypeSend.query'" type="primary" icon="ios-search" @click="onSearch" :loading="loading" style="margin-top:5px;">查询</Button>
    <Button v-auth="'statement.coalTypeSend.export'" type="warning" icon="share" @click="exportExcel" :loading="exportLoading" style="margin-top:5px;">{{ exportText }}</Button>
  ...
  export default {
    ...
    methods:{
      ...
      getList(){
        this.loading = true;
        this.$commonService
          .post("/salesReport/coalmineReportByCoalType", {
            dto: {
      ...
      formatExcelTemp(data) {
        try {
          ...
          document.getElementById("exportExcel").download = '柴家沟煤矿矿发煤种统计表.xls';
