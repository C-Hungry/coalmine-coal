...
<template>
  <div class="business-container">
    <DatePicker type="daterange" :value="datePickerValue" format="yyyy/MM/dd" @on-change="onDatePickerChange" confirm  placement="bottom-start" placeholder="起止日期" style="width: 200px;margin-top:5px;vertical-align: middle;"></DatePicker>
    <Input v-model="customerName" placeholder="收货单位" clearable style="width: 200px;margin-top:5px;" />
    <Button v-auth="'statement.coalPlat2Sales.query'" type="primary" icon="ios-search" @click="onSearch" :loading="loading" style="margin-top:5px;">查询</Button>
    <Button v-auth="'statement.coalPlat2Sales.export'" type="warning" icon="share" @click="exportExcel" :loading="exportLoading" style="margin-top:5px;">{{ exportText }}</Button>
  ...
  export default {
    ...
    methods:{
      ...
      getList(){
        this.loading = true;
        this.$commonService
          .post("/report/getNo2CoalPlatformList", {
            dto: {
      ...
      formatExcelTemp(data, jz, truckNum) {
        try {
              ...
              <div>
                <table class="zk-table" cellspacing="0" cellpadding="0" border="0">
                  ...
                  <tr style="height: 40px">
                    <th style="font-size: 16pt; font-family: 宋体; border: none;" colspan="6">
                      陕西柴家沟煤矿2号煤台明细表
                    </th>
                  </tr>
                  <tr>
                    <td colspan="5" style="text-align: left;border-left: none;">查询时间: 
          ...
          document.getElementById("exportExcel").download = '2号煤台明细表.xls';
