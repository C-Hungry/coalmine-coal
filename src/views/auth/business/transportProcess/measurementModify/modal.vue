  ...
  <div>
    <Modal id="modal" v-model="visible" width="850" :title="title">
      <div>
        ...
        <Button type="warning" icon="edit" v-auth="'transportProcess.measureModify.zcpz'" :disabled="selectTruckState < 50 || selectTruckState == 100" @click="modify(50)">除皮车辆 - 皮重修改</Button>
        <Button type="warning" icon="edit" v-auth="'transportProcess.measureModify.zccz'" :disabled="selectTruckState < 70 || selectTruckState == 100" @click="modify(70)">称重车辆 - 毛重修改</Button>
        <Button type="warning" icon="edit" v-auth="'transportProcess.measureModify.zcscbd'" :disabled="selectTruckState < 80 || selectTruckState == 100" @click="modify(80)">生成榜单车辆 - 计量数据修改</Button>
        <br><br>
...
export default {
  ...
  methods: {
    ...
    modify(state) {
      ...
      this.editType = state;
      this.editDlgTitle = state == 50 ? "除皮车辆 - 皮重修改" : state == 70 ? "称重车辆 - 毛重修改" : "生成榜单车辆 - 计量数据修改";
      this.formData = {
